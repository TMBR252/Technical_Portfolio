    ...
    projects: [
        {
            ...
            title: 'Primer',
            description:
                'I designed and built the Primer marketing site from 0 to 1: a product-first surface where the first interaction is the feasibility search itself.',
            longDescription:
            ...
            tools: ['Cursor', 'Claude Design', 'Figma'],
            status: 'ongoing',
            startDate: '2026-01-01',
            role: 'Product Engineer',
            roleDescription:
                'Responsible for research, conceptualization, design, engineering, and delivery of the marketing system and product entry.',
