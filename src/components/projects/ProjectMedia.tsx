...
type ProjectMediaProps = {
    ...
    onClick?: () => void;
    /** Soft grey stage + padding. Off by default so images fill. */
    staged?: boolean;
};

/**
 * Chrome-free project media frame - image fills by default (no grey mat).
 */
export function ProjectMedia({
    ...
    const frame = (
        <div
            ...
            className={cn(
                'overflow-hidden rounded-2xl bg-white shadow-[0_25px_80px_-12px_rgba(0,0,0,0.28)] dark:bg-zinc-950 dark:shadow-[0_25px_80px_-12px_rgba(0,0,0,0.65)]',
