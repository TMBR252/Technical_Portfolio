            ...
            <AnimatePresence>
                {selectedId && (
                    ...
                    >
                        ...
                        <button
                            onClick={prevImage}
                            className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 p-3 md:p-4 border border-white/20 bg-black/50 hover:bg-black/80 text-white rounded-full transition-all z-[110] group backdrop-blur-sm"
                            aria-label="Previous"
                        >
                            <ChevronLeft className="w-6 h-6 md:w-8 md:h-8 transition-colors" />
                        </button>

                        <button
                            onClick={nextImage}
                            className="absolute right-3 md:right-6 top-1/2 -translate-y-1/2 p-3 md:p-4 border border-white/20 bg-black/50 hover:bg-black/80 text-white rounded-full transition-all z-[110] group backdrop-blur-sm"
                            aria-label="Next"
                        >
                            <ChevronRight className="w-6 h-6 md:w-8 md:h-8 transition-colors" />
                        </button>
