...
const NODES_DATA: Record<string, NodeData[]> = {
    education: [
        { label: 'Product Craft', description: 'Continuous learning in design systems, UX engineering, and AI product patterns.', orbitIndex: 0, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1562774053-701939374585?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'AI Foundations', description: 'Applied ML, LLMs, and computer vision for product surfaces.', orbitIndex: 1, position: 0.25, imageUrl: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Full-Stack', description: 'Next.js, TypeScript, and modern frontend architecture.', orbitIndex: 0, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Design Systems', description: 'Reusable components, motion, and visual hierarchy.', orbitIndex: 1, position: 0.65, imageUrl: "https://images.unsplash.com/photo-1522202176988-66273c2fd55f?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'NYC Focus', description: 'Building for US product teams with clarity and polish.', orbitIndex: 0, position: 0.85, imageUrl: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Shipping', description: 'Prototypes to production, demos that feel inevitable.', orbitIndex: 1, position: 0.05, imageUrl: "https://images.unsplash.com/photo-1527689368864-3a821dbccc34?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    journey: [
        { label: 'Architecture', description: 'M.Arch UCLA, B.Arch Kentucky. Spatial thinking as a foundation.', orbitIndex: 0, position: 0.15, imageUrl: "https://images.unsplash.com/photo-1523240795612-9a054b0db644?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Development', description: 'Property development strategy on active real estate projects.', orbitIndex: 1, position: 0.35, imageUrl: "https://images.unsplash.com/photo-1552664730-d307ca884978?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Primitive AI', description: 'Founder of the spatial AI automation platform, 0 to 1.', orbitIndex: 0, position: 0.55, imageUrl: "https://images.unsplash.com/photo-1557804506-669a67965ba0?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Domain Experts', description: 'Translating developer and engineer judgment into systems.', orbitIndex: 1, position: 0.75, imageUrl: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: '0 to 1', description: 'Owning product direction and outcomes end to end.', orbitIndex: 0, position: 0.9, imageUrl: "https://images.unsplash.com/photo-1579621970563-ebec7560ff3e?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'New York', description: 'Building for US product teams from NYC.', orbitIndex: 1, position: 0.02, imageUrl: "https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ],
    experience: [
        { label: 'Founder', description: 'Primitive AI. 35+ agentic tools, 15+ municipal data streams.', orbitIndex: 0, position: 0.2, imageUrl: "https://images.unsplash.com/photo-1507413245164-6160d8298b31?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Product Eng.', description: 'H.A. Sack. Conduit routing automation, solo 0 to 1.', orbitIndex: 1, position: 0.45, imageUrl: "https://images.unsplash.com/photo-1454165833911-5421db635848?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Agentic Systems', description: 'Multi-tool orchestration and human-in-the-loop boundaries.', orbitIndex: 0, position: 0.6, imageUrl: "https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Evaluation', description: 'Adversarial red-teaming and regression detection.', orbitIndex: 1, position: 0.8, imageUrl: "https://images.unsplash.com/photo-1518433278988-c7bc488ce92d?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'UBE Platform', description: 'Co-founder. Blockchain remittance with POS hardware.', orbitIndex: 0, position: 0.95, imageUrl: "https://images.unsplash.com/photo-1581092580497-e0d23cbdf1dc?q=80&w=400&auto=format&fit=crop&fm=webp" },
        { label: 'Code Constraints', description: 'Zoning and NEC compliance modeled as system rules.', orbitIndex: 1, position: 0.1, imageUrl: "https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=400&auto=format&fit=crop&fm=webp" },
    ]
};
