            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                >
                    ...
                    <div className="p-8 relative z-10 transition-transform duration-500 group-hover:translate-x-1">
                        ...
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                            Chicago-based product designer making complicated workflows feel simple. Currently at Meridian Health. Previously at Searchless AI.
                        </p>
                    </div>
                    ...
                    <div className="flex-1 flex items-center justify-center relative p-8 mt-auto border-t border-black/10 dark:border-white/10 bg-gradient-to-b from-transparent to-black/5 dark:to-white/5 overflow-hidden">
                        ...
                        <div className="relative z-10 flex flex-col items-center transition-transform duration-500 group-hover:scale-105">
                            ...
                            <p className="text-[10px] font-mono text-white/90 uppercase tracking-widest bg-black/50 px-2 py-1 rounded backdrop-blur-sm border border-white/10 group-hover:border-blue-500/50 transition-colors">{portfolioData.personal.location}</p>
                        </div>
                ...
                >
                    ...
                    <div className="relative z-10 space-y-3 max-w-xl">
                        ...
                        <h3 className="text-2xl md:text-3xl font-black text-neutral-900 dark:text-white">Open to opportunities · {portfolioData.personal.location.replace(/,.*$/, '')}</h3>
                        <p className="text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
