  ...
  const CARDS = [
    {
      ...
      height: "h-[320px] sm:h-[400px] lg:h-[480px]",
    },
    {
      title: "The Gallery",
    ...
    },
    {
      ...
      colSpan: "lg:col-span-1",
      height: "h-[280px] sm:h-[360px] lg:h-[420px]",
    },
    {
      title: "Activity Feed",
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 md:px-8 lg:px-12 pt-4 pb-20 flex-grow flex flex-col">
        ...
        <div className="mt-14 flex flex-col items-center justify-center py-10 border-t border-border/50">
          ...
          >
            ...
            Interactive gallery items represent curated milestones of the engineering journey. © 2026 {portfolioData.personal.name}.
          </motion.p>
        </div>
      </div>
