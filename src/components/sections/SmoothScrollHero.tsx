...
const CenterImage = ({ scrollY }: { scrollY: MotionValue<number> }) => {
    ...
    return (
        <div className="sticky top-0 h-[100dvh] w-full flex items-center justify-center overflow-hidden z-0">
            <motion.div
                style={{
                    scale,
                    borderRadius,
            ...
            <div className="absolute inset-0 flex items-center justify-center z-10 px-4">
                ...
                >
                    ...
                    <h1 className="text-[clamp(2.75rem,12vw,15rem)] font-black text-foreground dark:text-white tracking-[-0.06em] leading-[0.8] uppercase text-center mb-[clamp(24px,4vh,48px)] -ml-2 px-2">
                        EXPERIENCE
                    </h1>
