                ...
                <AnimatePresence>
                    {isExpanded && (
                        ...
                        >
                            ...
                            <div className="flex-1 flex flex-col px-6 sm:px-10 lg:px-[6vw] pt-[4vh] pb-0 justify-between relative">
                                <div className="flex-1 flex flex-col justify-center max-w-[1600px] w-full mx-auto relative">

                                    {/* Close Button */}
                                    <div className="absolute top-0 right-0 sm:right-2 z-[10001]">
                                        <motion.button
                                    ...
                                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-8 lg:gap-x-12 gap-y-8 lg:gap-y-10">
                                ...
                                <div className="mt-auto overflow-hidden flex-shrink-0 relative">
                                    <motion.h2
                                        ...
                                        className="text-[clamp(2.5rem,14vw,18rem)] font-black leading-none text-zinc-900 dark:text-white tracking-tighter select-none text-center"
                                    >
                                        TYLER BRYAN
                                    </motion.h2>
                                </div>
