...
import { Menu, X, Moon, Sun, ChevronDown, Bot, Linkedin, Link2, Github, FileText } from 'lucide-react';
...
export function Navbar() {
    ...
    // Hide the header Marvin CTA while chat is open (close lives in the panel)
    useEffect(() => {
        const sync = () => {
                        ...
                        <div className="ml-auto flex items-center justify-end gap-2 h-12 lg:h-10 lg:ml-0 lg:justify-self-end shrink-0">
                            {mounted && (
                                <AnimatedThemeToggler
                                    className={cn(
                                        'hidden lg:inline-flex items-center justify-center size-10 p-0 touch-manipulation',
                                        navPill
                                    )}
                                />
                            )}
                                    ...
                                    >
                                        ...
                                        <span
                                            className={cn(
                                                ...
                                                /* Tablet: always show label (no hover). Desktop: expand on hover */
