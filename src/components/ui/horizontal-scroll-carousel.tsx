...
// Lucide icons matched to current skill set
...
export const HorizontalScrollCarousel = () => {
  ...
  // Mobile: vertical stack — no pin / horizontal scrub
  if (isMobile) {
    return (
      <section className="relative bg-background py-16 px-6">
        <div className="mb-10">
          <h2 className="text-4xl sm:text-5xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-foreground to-foreground/40 leading-[0.9] pb-2">
  ...
  return (
    ...
    >
      <div className="sticky top-0 flex flex-col h-[100dvh] overflow-hidden pb-8 md:pb-12">
