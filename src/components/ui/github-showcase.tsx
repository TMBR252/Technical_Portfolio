...
const GITHUB_USER = "TMBR252";

const PINNED_REPOS = [
  {
    name: "Product_Engineer_Portfolio",
    desc: "Design & product engineer portfolio built with Next.js, TypeScript, and Tailwind CSS — motion, AI product craft, and production-ready UI.",
    stars: 0,
    forks: 0,
    lang: "TypeScript",
    url: "https://github.com/TMBR252/Product_Engineer_Portfolio"
  },
  {
  ...
  },
  {
    ...
    desc: "Deep Learning and Generative AI for automated cybersecurity threat detection — SQL Injection, DDoS, Network Intrusion, and Malware analysis.",
    stars: 9,
    forks: 2,
  ...
  },
  {
    ...
    desc: "Autonomous multi-agent content orchestration system for high-performance blog drafting and research.",
    stars: 10,
    forks: 5,
    lang: "Vue",
    url: "#"
  ...
  {
    name: "DocsInsight-Engine",
    desc: "Private RAG platform for intelligent document analysis with local LLMs, LangChain, and vector search.",
    stars: 0,
    forks: 0,
    lang: "Python",
    url: "#"
  ...
  {
    name: "Web3-Guestbook-DApp",
    desc: "On-chain guestbook with wallet integration, Solidity contracts, and a polished Next.js frontend.",
    stars: 0,
    forks: 0,
    lang: "TypeScript",
    url: "#"
