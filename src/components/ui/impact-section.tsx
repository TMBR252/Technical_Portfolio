          ...
          <div className="flex flex-col md:flex-row md:items-end gap-3 md:gap-0 justify-center">
            ...
            return (
              <motion.div
                ...
                className={`${card.bg} ${card.text} relative overflow-hidden border border-black/10 dark:border-white/5 h-[280px] sm:h-[360px] md:h-auto cursor-pointer rounded-2xl md:rounded-none md:first:rounded-l-2xl md:last:rounded-r-2xl`}
              >
                <motion.div
