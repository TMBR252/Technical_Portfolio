...
const FallingText = dynamic(() => import('@/components/effects/FallingText'), {
    ssr: false,
    loading: () => <div className="h-[240px] md:h-[400px] w-full animate-pulse bg-zinc-100/5 dark:bg-zinc-800/5 rounded-xl" />
});
...
export default function AchievementsPage() {
    ...
    const isBelowLg = useIsMobile(BREAKPOINTS.LG);
                ...
                <div className="flex flex-col lg:flex-row relative items-start">
                    ...
                    <motion.div
                        ...
                        className={cn(
                            ...
                            isSidebarCollapsed && !isBelowLg && "items-center"
                        )}
                        style={{ willChange: isBelowLg ? "auto" : "width" }}
                    >
                ...
                >
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1 }}
                            viewport={{ once: true }}
                            className="relative w-full mx-auto h-[240px] md:h-[400px]"
                        >
