...
function SocialCard({ item }: { item: any }) {
    ...
    return (
        <a
            ...
            className="group relative flex h-[120px] w-[240px] sm:h-[140px] sm:w-[280px] flex-col justify-between rounded-3xl border border-neutral-200 dark:border-white/5 bg-white dark:bg-white/[0.02] p-5 sm:p-6 shadow-sm dark:shadow-2xl transition-all hover:bg-neutral-50 dark:hover:bg-white/5 hover:border-neutral-300 hover:scale-[1.02] hover:-translate-y-1 backdrop-blur-md overflow-hidden flex-shrink-0"
        >
...
export default function ContactPage() {
    ...
    const socialRow = ['linkedin', 'github', 'instagram'].map(getSocialItem);
    const row1Real = socialRow;
    const row2Real = socialRow;
            ...
            >
                ...
                <div className="relative w-full pt-48 pb-20">
                    <div className="w-full flex items-center justify-center opacity-20 select-none pointer-events-none">
                        <DynamicScrollVelocity
                            ...
                            velocity={20}
                            className="text-4xl sm:text-6xl md:text-7xl lg:text-[9rem] font-black tracking-tight uppercase whitespace-nowrap"
                ...
                <div className="container-creative px-4 md:px-8 max-w-[1800px] mx-auto pb-40">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start">
                        ...
                        {/* LEFT COLUMN: Lanyard */}
                        <div className="col-span-1 lg:col-span-4 relative lg:sticky top-0 h-[280px] sm:h-[400px] md:h-[500px] lg:h-[90vh] pointer-events-none z-20">
                ...
                {/* FAQ runway - shorter on mobile to avoid address-bar / scroll length issues */}
                <div ref={faqTriggerRef} className="h-[50dvh] md:h-[100dvh] w-full pointer-events-none" />
            </motion.div >
