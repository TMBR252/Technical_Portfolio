                    ...
                    >
                        ...
                        >
                            <motion.h1
                                ...
                                className="relative z-10 text-[clamp(2.5rem,9vw,7rem)] font-semibold uppercase leading-[0.9] tracking-tight text-zinc-800 dark:text-zinc-400 group-hover:text-black dark:group-hover:text-white select-none transition-colors duration-500"
                            >
                                SKILLS & TOOLS
