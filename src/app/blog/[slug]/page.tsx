        ...
        <main className="min-h-screen bg-background pb-24 pt-32">
            ...
            <div className="container max-w-7xl mx-auto px-6 mb-12">
                <motion.div
                    ...
                    className="relative w-full aspect-[16/9] md:aspect-[21/9] lg:aspect-[2/1] rounded-3xl overflow-hidden border border-border/40 shadow-2xl"
                >
                    <Image
                        src={post.image}
                        alt={post.title}
            ...
            <div className="container max-w-7xl mx-auto px-6 mb-16">
                <div className="flex flex-col md:flex-row items-center justify-between border-y border-border/40 py-6 gap-6">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto justify-end">
                        ...
                        <Link href={portfolioData.personal.socialLinks.find((s) => s.platform === 'LinkedIn')?.url || '#'} target="_blank" className="p-2 text-muted-foreground hover:text-primary transition-colors bg-secondary/10 rounded-lg hover:bg-primary/10">
                            <Linkedin className="w-4 h-4" />
                        </Link>
                        <Link href={portfolioData.personal.socialLinks.find((s) => s.platform === 'GitHub')?.url || '#'} target="_blank" className="p-2 text-muted-foreground hover:text-primary transition-colors bg-secondary/10 rounded-lg hover:bg-primary/10">
                            <Github className="w-4 h-4" />
                        </Link>
                        <Link href={portfolioData.personal.linktreeUrl || portfolioData.personal.website || '#'} target="_blank" className="p-2 text-muted-foreground hover:text-primary transition-colors bg-secondary/10 rounded-lg hover:bg-primary/10">
