                ...
                <header className="sticky top-[25vh] z-0 pb-12 flex flex-col items-center justify-center pointer-events-auto h-auto">
                    <div className="relative z-10 max-w-5xl mx-auto text-center px-4">
                        <motion.h1
                            ...
                            className="text-4xl sm:text-5xl md:text-6xl lg:text-[5.5rem] font-black text-foreground leading-tight tracking-[-0.04em] uppercase text-balance cursor-pointer group"
                        >
            ...
            <div className="relative z-20 pt-12 pb-24 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-background via-background/80 to-background dark:from-black dark:via-black dark:to-black">
                ...
                <div className="container mx-auto relative z-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-10 mb-16 items-end justify-between border-b border-foreground/5 pb-8">
                        <div className="flex flex-wrap gap-x-4 sm:gap-x-8 lg:gap-x-12 gap-y-3 sm:gap-y-6">
                            {categories.map((cat) => {
                                const count = cat === 'all'
                    ...
                    >
                        ...
                        <motion.div
                            className="pointer-events-none fixed left-0 top-0 z-[100] hidden lg:flex items-center justify-center mix-blend-exclusion"
                            style={{
                                x: springX,
                                y: springY,
                        ...
                        {viewMode === 'grid' ? (
                            ...
                            <>
                                {/* Mobile/tablet: stacked cards — FlowingMenu is desktop-oriented */}
                                ...
                                <div
                                    style={{ height: 'min(800px, 80dvh)', position: 'relative' }}
